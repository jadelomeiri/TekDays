...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'startDate', 'error')} required">
	...
	<g:datePicker name="startDate" precision="day"  value="${tekEventInstance?.startDate}"  years="${2016..2022}"/>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
	...
	<g:datePicker name="endDate" precision="day"  value="${tekEventInstance?.endDate}" years="${2016..2022}" />
