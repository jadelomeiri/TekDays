	...
	<body>
		...
		<div id="show-tekUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list tekUser">
				...
				<g:if test="${tekUserInstance?.wesbite}">
				<li class="fieldcontain">
					<span id="wesbite-label" class="property-label"><g:message code="tekUser.wesbite.label" default="Wesbite" /></span>
					
						<span class="property-value" aria-labelledby="wesbite-label"><g:fieldValue bean="${tekUserInstance}" field="wesbite"/></span>
