...
<div class="fieldcontain ${hasErrors(bean: tekUserInstance, field: 'wesbite', 'error')} required">
	<label for="wesbite">
		<g:message code="tekUser.wesbite.label" default="Wesbite" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="wesbite" required="" value="${tekUserInstance?.wesbite}"/>
